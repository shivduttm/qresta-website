...
export default function RestaurantPage() {
  ...
  // Tags the lead as a restaurant enquiry, so it is sorted the same way
  // a /cloudkitchen or /fitbizz request is.
  const onDemo = () => openDemoModal('restaurant');
